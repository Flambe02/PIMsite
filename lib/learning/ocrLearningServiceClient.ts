...
export class OCRLearningServiceClient {
  /**
   * Stocke les données d'apprentissage OCR dans Supabase (version client)
   */
  ...
  /**
   * Trouve des données d'apprentissage similaires pour améliorer la confiance (version client)
   */
  ...
  /**
   * Améliore la confiance basée sur les données d'apprentissage (version client)
   */
  ...
  /**
   * Génère des insights d'apprentissage pour l'utilisateur (version client)
   */
  ...
  /**
   * Récupère les statistiques d'apprentissage par pays (version client)
   */
