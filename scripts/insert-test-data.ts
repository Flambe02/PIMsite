...
/**
 * Script pour insérer les données de test avec le vrai UUID
 */
...
async function insertTestData() {
  ...
  try {
    // UUID de l'utilisateur créé précédemment
    ...
    // 2. Créer des données de test avec différents profils
    ...
    console.error('❌ Erreur critique lors de l\'insertion:', error);
  }
}
