            ...
            <div>
              ...
              <div className="flex gap-4 mb-8">
                ...
                <Button
                  ...
                  className="flex-1 py-6 text-lg"
                  onClick={() => { setSelectedProfile("PJ"); setPjView("simplified"); setSelectedItem("pj_valor_servicos"); }}
                >
                  PJ
                </Button>
                <Button
                                ...
                                {pjView === 'complete' && (
                                  <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 rounded-xl shadow-lg border border-blue-100 p-6">
                                      ...
                                      <div className="space-y-2 mb-4">
                                        <button className={`w-full flex justify-between items-center px-3 py-3 rounded transition ${selectedItem === 'pj_das' ? 'bg-blue-100' : 'hover:bg-blue-50'}`} onClick={() => setSelectedItem('pj_das')}>
                                        ...
                                        <button className={`w-full flex justify-between items-center px-3 py-2 rounded transition ${selectedItem === 'pj_plano_saude' ? 'bg-blue-100' : 'hover:bg-blue-50'}`} onClick={() => setSelectedItem('pj_plano_saude')}>
