    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-emerald-50 py-6 px-2">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden border border-gray-100">
          ...
          <form action={tab==='login' ? "/auth/login" : "/auth/signup"} method="POST" className="space-y-4">
            ...
            {tab==='register' && (
              <div className="space-y-2">
                ...
                <Input id="username" name="username" type="text" autoComplete="username" required placeholder="Seu nome de usuário" />
              </div>
            )}
            <div className="space-y-2">
        ...
        <div className="hidden md:block md:w-1/2 relative bg-black/80">
          ...
          >
            <source src="/videos/pim-career-forest.mp4" type="video/mp4" />
          </video>
          <div className="relative z-10 flex flex-col justify-between h-full p-8 text-white" style={{ minHeight: 600 }}>
            <div>
              ...
              <div className="flex gap-2 mb-4">
                <img src="/images/pim-career1.jpg" alt="Equipe PIM" className="w-20 h-14 object-cover rounded-lg border-2 border-white shadow" />
                <img src="/images/pim-career2.jpg" alt="Equipe PIM" className="w-20 h-14 object-cover rounded-lg border-2 border-white shadow" />
                <img src="/images/pim-career3.jpg" alt="Equipe PIM" className="w-20 h-14 object-cover rounded-lg border-2 border-white shadow" />
              </div>
            </div>
