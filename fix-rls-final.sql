-- Script final pour corriger toutes les politiques RLS
-- Exécutez ce script dans l'éditeur SQL de Supabase

-- ========================================
-- 1. CRÉATION DU BUCKET PAYSLIPS
-- ========================================

-- Créer le bucket payslips s'il n'existe pas
...
-- ========================================
-- 2. VÉRIFICATION DE LA TABLE HOLERITES
-- ========================================

-- Créer la table holerites si elle n'existe pas
